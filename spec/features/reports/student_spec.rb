...
" do
  ...
  given!(:test_attempt) { create(:attempt, test: test, author: student) }
  given!(:answer) { create(:static_question, :correct, question: question, attempt: test_attempt, author: student) }
  given!(:answer_wrong) { create(:static_question, :wrong, question: question, attempt: test_attempt, author: student) }

  given!(:test_attempt_admin) { create(:attempt, test: test, author: admin) }
  given!(:answers_admin) { create_list(:static_question, 5, :correct, question: question, attempt: test_attempt_admin, author: admin) }
