...
RSpec.describe Teacher::QuestionsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    it 'redirects to update parameters view' do
      post :create, params: question_params
      expect(response).to redirect_to edit_teacher_question_parameters_path(assigns(:question))
    end
  ...
  describe 'PATCH #update' do
    ...
    describe 'updates formula' do
      ...
      it 'redirects to parameters edit' do
        ...
        expect(response).to redirect_to edit_teacher_question_parameters_path(question)
      end
    end
  end
end
