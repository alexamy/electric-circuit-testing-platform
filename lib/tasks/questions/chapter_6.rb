  ...
  module Chapter6
    ...
    QUESTIONS = {
      ...
      2 => {
        ...
        formula_text: 'Out=clamp(R5*(In1/R1+In2/R2+In3/R3+In4/R4+In5/R5), Vcc2, Vcc1)',
        parameters: {
          'In1' => { minimum: 0.1, maximum: 1, step: 0.1, unit: 'В' },
          'In2' => { factory: :formula, formula: '2*In1', unit: 'В' },
          'In3' => { factory: :formula, formula: '4*In1', unit: 'В' },
          'In4' => { factory: :formula, formula: '8*In1', unit: 'В' },
          'In5' => { factory: :formula, formula: '16*In1', unit: 'В' },
          'R1' => { minimum: 1_000, maximum: 10_000, step: 1_000, unit: 'Ом' },
          'R2' => { minimum: 1_000, maximum: 10_000, step: 1_000, unit: 'Ом' },
          'R3' => { minimum: 1_000, maximum: 10_000, step: 1_000, unit: 'Ом' },
          'R4' => { minimum: 1_000, maximum: 10_000, step: 1_000, unit: 'Ом' },
      ...
      3 => {
        ...
        parameters: {
          ...
          'In5' => { minimum: 1, maximum: 5, step: 1, unit: 'В' },
          'R1' => { minimum: 1_000, maximum: 10_000, step: 1_000, unit: 'Ом' },
          'R2' => { factory: :formula, formula: '2*R1', unit: 'Ом' },
          'R3' => { factory: :formula, formula: '4*R1', unit: 'Ом' },
          'R4' => { factory: :formula, formula: '8*R1', unit: 'Ом' },
          'R5' => { factory: :formula, formula: '16*R1', unit: 'Ом' },
          'Vcc1' => { minimum: 5, maximum: 12, step: 1, unit: 'В' },
          'Vcc2' => { minimum: -12, maximum: -5, step: 1, unit: 'В' },
        }
      }
